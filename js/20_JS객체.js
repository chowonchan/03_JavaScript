/* JS 객체 생성 + 다루기
  ...
  - JS 객체를 콘솔에 출력하는 경우
    입력한 순서와 관계 없이 key 오름차순으로 정렬되어 출력됨
*/
...
btn2.addEventListener("click", () => {
  ...
  /* this 참조 변수
      ...
      2) <butoon onclick="testFn(this)">테스트</butoon>
        여기서 this == 이벤트가 발생한 요소(클릭된 button)

      3) 화살표 함수내에서 this == window 객체
...
/* 입력값을 이용해 Student 객체를 생성하여 배열에 저장 */
...
checkJSON.addEventListener("click", ()=>{
  ...
  // 기상청 서버에 7/12 pm 10시 전국 미세먼지 농도를 JSON으로 받아오기
